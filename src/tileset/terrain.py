...
from tileset import terrain
from typing import Dict, Literal, TypeVar, Callable, List, Tuple, Any, TypedDict
...
class CV5:
    ...
    @staticmethod
    def chunk_analyze(chunk: Tuple[Any, ...]):
        if chunk[0] == 1:
    ...
    @staticmethod
    def chunk_to_tile(chunk: Tuple[Any, ...]):
        tile: CV5Tile = {
    ...
    @staticmethod
    def chunk_to_doodad(chunk: Tuple[Any, ...]):
        doodad: CV5Doodad = {
            "terran_type": chunk[0],
    ...
    @staticmethod
    def analyze_flag(flag: int, isDoodad: bool):
...
class VX4:
    ...
    @staticmethod
    def chunk_to_flags(chunk: tuple):
    ...
    def __init__(self, tileset: Tilesets):
        result = terrain.read(tileset, "vx4ex", "16I", self.chunk_to_flags)
        self.graphics = result
...
class WPE:
    ...
    def __init__(self, tileset: Tilesets):
        result = terrain.read(tileset, "wpe", "4B", self.chunk_to_pallette)
        self.graphics = result
